/// @file Mo2Mf-converter.cpp
/// @brief Code for the Mo2Mf-converter executable: MoEDAL Timepix -> MAFalda
...
/// @brief Mo2Mf-converter: Converts Calibration data to the MAFalda format.
///
...
int main(int argc, char ** argv) {
  ...
  cout << "" << endl
       << "==============================" << endl
       << " CERN@school: Mo2Mf-converter " << endl
       << "==============================" << endl
       << "*" << endl;


  cout << "* MoEDAL Timepix file name:    '" << argv[1] << "'" << endl;
  ...
  Mo2MfConverter converter(argv[1], argv[2], argv[3], num_frames_per_root_file, num_frames_to_read, dbg);
