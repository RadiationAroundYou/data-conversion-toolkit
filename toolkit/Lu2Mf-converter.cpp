/// @file Lu2Mf-converter.cpp
/// @brief Code for the Lu2Mf-converter executable: LUCID -> MAFalda
...
/// @brief Lu2Mf-converter: Converts LUCID data to the MAFalda format.
///
...
//  checkParameters(argc, argv, &tempScratchDir);
  ...
  cout << "" << endl
       << "==============================" << endl
       << " CERN@school: Lu2Mf-converter " << endl
       << "==============================" << endl
       << "*" << endl;
