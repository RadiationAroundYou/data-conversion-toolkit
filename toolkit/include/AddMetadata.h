...
class AddMetadata {
 ...
 public:
  ...
  explicit AddMetadata(TString xmlPath);
 ...
 protected:
  ...
  ///
  /// @param [in] cmd The AddMetadata object to copy.
  AddMetadata(const AddMetadata & cmd);

  /// @brief Copy assignment operator (protected).
  ///
  /// @param [in] cmd The AddMetadata object to copy.
  AddMetadata & operator=(const AddMetadata & cmd); 
