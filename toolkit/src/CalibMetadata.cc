...
//
// CalibMetadata destructor
//
CalibMetadata::~CalibMetadata() {}

//
// CalibMetadata::ParseXmlFile
//
Bool_t CalibMetadata::ParseXmlFile() {
...
//
// CalibMetadata::PrintContents
//
void CalibMetadata::PrintContents() {
  cout
    << endl
  ...
  cout
    ...
    << "*--> Coincidence mode:                       " 
      << Utils::MyHex(fCoincidence_mode)                               << endl
    << "*--> Coincidence delay:                      " 
      << Utils::MyHex(fCoincidence_delay)                              << endl
  ...
  //cout
    ...
    << "*--> Timepix clock:                          "
      << Utils::MyHex(fTimepix_clock)                                  << endl
  ...
  cout
    ...
    << endl;
}// end of CalibMetadata::PrintContents method.
