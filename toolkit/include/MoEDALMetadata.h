/// @file MoEDALMetadata.h
/// @brief Header file for the MoEDAL metadata container class.

#ifndef MoEDALMetadata_h
#define MoEDALMetadata_h 1
...
/// @brief A container class for the MoEDAL Timepix metadata.
///
/// @author T. Whyntie (CERN\@school - t.whyntie@qmul.ac.uk)
/// @date Summer 2014
class MoEDALMetadata {

 public:
  /// @brief Constructor.
  ///
  /// @param [in] xmlPath The full path to the XML metadata file.
  explicit MoEDALMetadata(TString xmlPath);
 ...
 protected:
  ...
  ///
  /// @param [in] cmd The MoEDALMetadata object to copy.
  MoEDALMetadata(const MoEDALMetadata & cmd);

  /// @brief Copy assignment operator (protected).
  ///
  /// @param [in] cmd The MoEDALMetadata object to copy.
  MoEDALMetadata & operator=(const MoEDALMetadata & cmd); 
